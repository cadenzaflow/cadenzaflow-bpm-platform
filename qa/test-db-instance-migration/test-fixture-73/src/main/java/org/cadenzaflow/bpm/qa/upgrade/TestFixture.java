...
import org.cadenzaflow.bpm.qa.upgrade.scenarios.compensation.InterruptingEventSubProcessNestedCompensationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.compensation.NestedCompensationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.compensation.NestedMultiInstanceCompensationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.compensation.NonInterruptingEventSubProcessCompensationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.compensation.ParallelMultiInstanceCompensationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.compensation.SequentialMultiInstanceCompensationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.compensation.SingleActivityCompensationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.compensation.SingleActivityConcurrentCompensationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.job.JobMigrationScenario;
import org.cadenzaflow.bpm.qa.upgrade.scenarios.sentry.SentryScenario;
