...
public class TestWarDeploymentResumePreviousOnProcessDefinitionKey  extends AbstractFoxPlatformIntegrationTest {
  ...
  public static WebArchive processArchive2() {
    return initWebArchiveDeployment("pa2.war", "org/cadenzaflow/bpm/integrationtest/deployment/war/resumePreviousVersionsOnProcessDefinitionKey_processes.xml")
      .addAsResource("org/cadenzaflow/bpm/integrationtest/deployment/war/testDeployProcessArchiveV2.bpmn20.xml");
