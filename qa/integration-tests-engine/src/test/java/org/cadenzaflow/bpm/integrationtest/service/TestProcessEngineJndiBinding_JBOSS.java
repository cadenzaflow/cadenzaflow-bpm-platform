 ...
 */
package org.cadenzaflow.bpm.integrationtest.service;
...
public class TestProcessEngineJndiBinding_JBOSS extends AbstractFoxPlatformIntegrationTest {
  ...
  public void testDefaultProcessEngineBindingCreated() {
    ...
    try {
      ProcessEngine processEngine = InitialContext.doLookup("java:global/cadenzaflow-bpm-platform/process-engine/default");
