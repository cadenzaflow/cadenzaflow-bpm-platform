 ...
 */
package org.cadenzaflow.bpm.engine.spring.test.scripttask;
...
@ContextConfiguration(locations = {
    "classpath:org/cadenzaflow/bpm/engine/spring/test/scripttask/ScriptTaskLimitedBeansTest-applicationContext.xml" })
