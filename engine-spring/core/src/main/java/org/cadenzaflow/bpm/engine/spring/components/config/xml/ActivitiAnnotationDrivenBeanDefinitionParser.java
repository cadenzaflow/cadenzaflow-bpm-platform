 ...
 */
package org.cadenzaflow.bpm.engine.spring.components.config.xml;


import org.cadenzaflow.bpm.engine.spring.components.ActivitiContextUtils;
import org.cadenzaflow.bpm.engine.spring.components.aop.ProcessStartAnnotationBeanPostProcessor;
import org.cadenzaflow.bpm.engine.spring.components.scope.ProcessScope;
...
/**
 * registers support for handling the annotations in the org.cadenzaflow.bpm.engine.annotations package.
 * <p/>
 ...
 * {@link org.cadenzaflow.bpm.engine.test.spring.components.registry.ActivitiStateHandlerRegistry} if none exists.
 *
 * @author Josh Long
 * @since 5.3
 */
