 ...
 */
package org.cadenzaflow.bpm.engine.spring.application;

import java.util.logging.Level;
import java.util.logging.Logger;
import javax.servlet.ServletContext;
import org.cadenzaflow.bpm.application.AbstractProcessApplication;
import org.cadenzaflow.bpm.application.ProcessApplicationElResolver;
import org.cadenzaflow.bpm.application.impl.EjbProcessApplication;
import org.cadenzaflow.bpm.engine.spring.ApplicationContextElResolver;
 ...
 *    <li>Bootstrapping through {@link org.cadenzaflow.bpm.application.impl.ServletProcessApplication}. In this case we have access to the {@link ServletContext}
...
public class SpringProcessApplicationElResolver implements ProcessApplicationElResolver {
  ...
  public ELResolver getElResolver(AbstractProcessApplication processApplication) {
    ...
    } else if (processApplication instanceof org.cadenzaflow.bpm.application.impl.ServletProcessApplication) {
      // Using fully-qualified class name instead of import statement to allow for automatic transformation
      org.cadenzaflow.bpm.application.impl.ServletProcessApplication servletProcessApplication = (org.cadenzaflow.bpm.application.impl.ServletProcessApplication) processApplication;
