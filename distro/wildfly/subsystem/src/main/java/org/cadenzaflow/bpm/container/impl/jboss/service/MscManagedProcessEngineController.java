 ...
 */
package org.cadenzaflow.bpm.container.impl.jboss.service;
...
import org.cadenzaflow.bpm.container.impl.jboss.config.ManagedJtaProcessEngineConfiguration;
...
import org.cadenzaflow.bpm.container.impl.jboss.util.Tccl;
import org.cadenzaflow.bpm.container.impl.jboss.util.Tccl.Operation;
import org.cadenzaflow.bpm.container.impl.jmx.services.JmxManagedProcessEngineController;
...
import org.cadenzaflow.bpm.engine.impl.cfg.JakartaTransactionProcessEngineConfiguration;
...
public class MscManagedProcessEngineController extends MscManagedProcessEngine {
  ...
  private Object createInstance(String configurationClassName) {
    try {
      ...
      throw new ProcessEngineException("Could not load '"+configurationClassName+"': the class must be visible from the cadenzaflow-wildfly-subsystem module.", e);
    }
  }
