...
public class DemoDataGenerator {
    ...
    public void createUsers(ProcessEngine engine) {
      ...
      user.setEmail("demo@cadenzaflow.org");
      ...
      user2.setEmail("john@cadenzaflow.org");
      ...
      user3.setEmail("mary@cadenzaflow.org");
      ...
      user4.setEmail("peter@cadenzaflow.org");
      ...
      identityService.createMembership("demo", "cadenzaflow-admin");
