 ...
 */
package org.cadenzaflow.bpm.spring.boot.starter.rest.config.fetchandlock;

import jakarta.servlet.ServletContext;
import org.cadenzaflow.bpm.spring.boot.starter.rest.test.TestRestApplication;
...
@TestPropertySource(properties = {"cadenzaflow.bpm.rest-api.fetch-and-lock.unique-worker-request=false"})
