...
import org.cadenzaflow.bpm.engine.impl.cfg.CompositeProcessEnginePlugin;
...
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaAuthorizationConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaDatasourceConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaDeploymentConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaFailedJobConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaHistoryConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaHistoryLevelAutoHandlingConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaJobConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaMetricsConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.CamundaProcessEngineConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.condition.NeedsHistoryAutoConfigurationCondition;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.id.IdGeneratorConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.custom.CreateAdminUserConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.custom.CreateFilterConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultAuthorizationConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultDatasourceConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultDeploymentConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultFailedJobConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultHistoryConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultHistoryLevelAutoHandlingConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultJobConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultJobConfiguration.JobConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultMetricsConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.DefaultProcessEngineConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.configuration.impl.GenericPropertiesConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.event.EventPublisherPlugin;
import org.cadenzaflow.bpm.spring.boot.starter.jdbc.HistoryLevelDeterminator;
import org.cadenzaflow.bpm.spring.boot.starter.property.CamundaBpmProperties;
import org.cadenzaflow.bpm.spring.boot.starter.telemetry.CamundaIntegrationDeterminator;
import org.cadenzaflow.bpm.spring.boot.starter.util.CamundaSpringBootUtil;
...
public class CamundaBpmConfiguration {
  ...
  @ConditionalOnProperty(prefix = "cadenzaflow.bpm.job-execution", name = "enabled", havingValue = "true", matchIfMissing = true)
  ...
  @ConditionalOnProperty(prefix = "cadenzaflow.bpm", name = "history-level", havingValue = "auto", matchIfMissing = false)
  ...
  @Bean
  @ConditionalOnProperty(prefix = "cadenzaflow.bpm.admin-user", name = "id")
  ...
  @Bean
  @ConditionalOnProperty(prefix = "cadenzaflow.bpm.filter", name = "create")
