 ...
 */
package org.cadenzaflow.bpm.spring.boot.starter.contextcache.pa;

import org.cadenzaflow.bpm.engine.ProcessEngines;
import org.cadenzaflow.bpm.spring.boot.starter.contextcache.AbstractContextCacheTest;
import org.cadenzaflow.bpm.spring.boot.starter.test.pa.TestProcessApplication;
...
@SpringBootTest(
  ...
  properties = {
    ...
    "cadenzaflow.bpm.generate-unique-process-application-name=true",
