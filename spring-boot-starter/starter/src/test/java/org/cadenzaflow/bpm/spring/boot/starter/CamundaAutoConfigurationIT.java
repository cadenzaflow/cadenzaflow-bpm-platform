...
import org.cadenzaflow.bpm.spring.boot.starter.AdditionalCammundaBpmConfigurations.AfterStandardConfiguration;
import org.cadenzaflow.bpm.spring.boot.starter.AdditionalCammundaBpmConfigurations.BeforeStandardConfiguration;
...
@SpringBootTest(
  ...
  properties = { "cadenzaflow.bpm.admin-user.id=admin"}
)
