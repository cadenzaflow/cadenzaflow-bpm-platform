= cadenzaflow BPMN model API

The cadenzaflow BPMN model API is a simple, lightweight Java library for parsing, creating and editing BPMN 2.0 XML files. It is licensed under the Apache 2.0 license.

[NOTE]
====
CadenzaFlow BPMN model can be used standalone, independenly of CadenzaFlow Platform / process engine.
====

* Web Site: https://cadenzaflow.com/
* User Guide: link:http://docs.cadenzaflow.org/latest/guides/user-guide/#bpmn-model-api[http://docs.camunda.org]
...
* Contribution Guidelines: https://cadenzaflow.com/learn/community/#contribute
...
For more complex examples see the link:https://docs.cadenzaflow.org/manual/latest/user-guide/model-api/bpmn-model-api/fluent-builder-api/[docs],
the tests in link:src/test/java/org/cadenzaflow/bpm/model/bpmn/builder/ProcessBuilderTest.java[ProcessBuilderTest.java] or this
link:https://github.com/cadenzaflow/camunda-bpm-examples/tree/master/bpmn-model-api/generate-process-fluent-api[example].
...
link:src/test/java/org/cadenzaflow/bpm/model/bpmn/CreateModelTest.java[CreateModelTest.java].
...
Read the https://cadenzaflow.com/bpmn/[BPMN 2.0 Tutorial on camunda.com].

=== Which Java (JRE) Version is required?

Java JRE 1.8+ is required. We test cadenzaflow BPMN model API on Oracle and IBM JVMs.

=== Does this API support all BPMN 2.0 Elements?

No, but support is already quite extensive. See
link:src/main/java/org/cadenzaflow/bpm/model/bpmn/instance[org.cadenzaflow.bpm.model.bpmn.instance]
