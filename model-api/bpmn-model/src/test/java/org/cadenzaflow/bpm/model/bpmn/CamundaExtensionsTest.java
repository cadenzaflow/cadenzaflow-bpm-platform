...
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.BUSINESS_RULE_TASK;
...
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.SCRIPT_TASK_ID;
...
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_CLASS_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_DELEGATE_EXPRESSION_API;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_DELEGATE_EXPRESSION_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_DUE_DATE_API;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_DUE_DATE_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_EXECUTION_EVENT_API;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_EXECUTION_EVENT_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_EXPRESSION_API;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_EXPRESSION_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_FLOW_NODE_JOB_PRIORITY;
...
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_GROUPS_LIST_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_GROUPS_XML;
...
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_PRIORITY_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_PROCESS_JOB_PRIORITY;
...
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_STRING_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_TASK_EVENT_API;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_TASK_EVENT_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_TYPE_API;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_TYPE_XML;
...
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_USERS_LIST_XML;
import static org.cadenzaflow.bpm.model.bpmn.BpmnTestConstants.TEST_USERS_XML;
...
import static org.cadenzaflow.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_ERROR_CODE_VARIABLE;
import static org.cadenzaflow.bpm.model.bpmn.impl.BpmnModelConstants.CAMUNDA_ATTRIBUTE_ERROR_MESSAGE_VARIABLE;
...
import org.cadenzaflow.bpm.model.bpmn.instance.BaseElement;
import org.cadenzaflow.bpm.model.bpmn.instance.BpmnModelElementInstance;
import org.cadenzaflow.bpm.model.bpmn.instance.BusinessRuleTask;
import org.cadenzaflow.bpm.model.bpmn.instance.CallActivity;
import org.cadenzaflow.bpm.model.bpmn.instance.EndEvent;
import org.cadenzaflow.bpm.model.bpmn.instance.Error;
import org.cadenzaflow.bpm.model.bpmn.instance.ErrorEventDefinition;
import org.cadenzaflow.bpm.model.bpmn.instance.Expression;
import org.cadenzaflow.bpm.model.bpmn.instance.MessageEventDefinition;
import org.cadenzaflow.bpm.model.bpmn.instance.ParallelGateway;
import org.cadenzaflow.bpm.model.bpmn.instance.Process;
import org.cadenzaflow.bpm.model.bpmn.instance.ScriptTask;
import org.cadenzaflow.bpm.model.bpmn.instance.SendTask;
import org.cadenzaflow.bpm.model.bpmn.instance.SequenceFlow;
import org.cadenzaflow.bpm.model.bpmn.instance.ServiceTask;
import org.cadenzaflow.bpm.model.bpmn.instance.StartEvent;
import org.cadenzaflow.bpm.model.bpmn.instance.TimerEventDefinition;
...
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaConnectorId;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaConstraint;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaEntry;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaExecutionListener;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaFailedJobRetryTimeCycle;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaField;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaFormData;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaFormField;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaFormProperty;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaIn;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaInputOutput;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaInputParameter;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaList;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaMap;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaOut;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaOutputParameter;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaPotentialStarter;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaProperties;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaProperty;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaScript;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaTaskListener;
import org.cadenzaflow.bpm.model.bpmn.instance.camunda.CamundaValue;
