 ...
 */
package org.cadenzaflow.bpm.engine.cdi.test.impl.util;
...
import org.cadenzaflow.bpm.engine.cdi.test.CdiProcessEngineTestCase;
import org.cadenzaflow.bpm.engine.cdi.test.impl.beans.InjectedProcessEngineBean;
...
public class InjectCustomProcessEngineTest extends CdiProcessEngineTestCase {
  ...
  @Before
  public void init() {
    processEngine = TestHelper.getProcessEngine("org/cadenzaflow/bpm/engine/cdi/test/impl/util/cadenzaflow.cfg.xml");
