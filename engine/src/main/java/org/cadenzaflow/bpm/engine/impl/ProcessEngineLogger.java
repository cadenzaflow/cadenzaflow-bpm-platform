...
import java.net.URL;
import org.cadenzaflow.bpm.application.impl.ProcessApplicationLogger;
import org.cadenzaflow.bpm.container.impl.ContainerIntegrationLogger;
import org.cadenzaflow.bpm.engine.ProcessEngineConfiguration;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.BpmnBehaviorLogger;
import org.cadenzaflow.bpm.engine.impl.bpmn.parser.BpmnParseLogger;
import org.cadenzaflow.bpm.engine.impl.cfg.ConfigurationLogger;
import org.cadenzaflow.bpm.engine.impl.cfg.TransactionLogger;
import org.cadenzaflow.bpm.engine.impl.cmd.CommandLogger;
import org.cadenzaflow.bpm.engine.impl.cmmn.behavior.CmmnBehaviorLogger;
import org.cadenzaflow.bpm.engine.impl.cmmn.operation.CmmnOperationLogger;
import org.cadenzaflow.bpm.engine.impl.cmmn.transformer.CmmnTransformerLogger;
import org.cadenzaflow.bpm.engine.impl.core.CoreLogger;
import org.cadenzaflow.bpm.engine.impl.db.EnginePersistenceLogger;
import org.cadenzaflow.bpm.engine.impl.digest.SecurityLogger;
import org.cadenzaflow.bpm.engine.impl.dmn.DecisionLogger;
import org.cadenzaflow.bpm.engine.impl.externaltask.ExternalTaskLogger;
import org.cadenzaflow.bpm.engine.impl.identity.IndentityLogger;
import org.cadenzaflow.bpm.engine.impl.incident.IncidentLogger;
import org.cadenzaflow.bpm.engine.impl.interceptor.ContextLogger;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.JobExecutorLogger;
import org.cadenzaflow.bpm.engine.impl.metrics.MetricsLogger;
import org.cadenzaflow.bpm.engine.impl.migration.MigrationLogger;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.JobEntity;
import org.cadenzaflow.bpm.engine.impl.plugin.AdministratorAuthorizationPluginLogger;
import org.cadenzaflow.bpm.engine.impl.pvm.PvmLogger;
import org.cadenzaflow.bpm.engine.impl.scripting.ScriptLogger;
import org.cadenzaflow.bpm.engine.impl.test.TestLogger;
import org.cadenzaflow.bpm.engine.impl.util.EngineUtilLogger;
