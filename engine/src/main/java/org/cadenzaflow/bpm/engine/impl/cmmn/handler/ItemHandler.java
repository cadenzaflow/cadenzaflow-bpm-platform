...
import org.cadenzaflow.bpm.engine.impl.bpmn.helper.CmmnProperties;
import org.cadenzaflow.bpm.engine.impl.bpmn.parser.FieldDeclaration;
import org.cadenzaflow.bpm.engine.impl.cmmn.CaseControlRule;
import org.cadenzaflow.bpm.engine.impl.cmmn.behavior.CaseControlRuleImpl;
import org.cadenzaflow.bpm.engine.impl.cmmn.behavior.CmmnActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.cmmn.listener.ClassDelegateCaseExecutionListener;
import org.cadenzaflow.bpm.engine.impl.cmmn.listener.DelegateExpressionCaseExecutionListener;
import org.cadenzaflow.bpm.engine.impl.cmmn.listener.ExpressionCaseExecutionListener;
import org.cadenzaflow.bpm.engine.impl.cmmn.listener.ScriptCaseExecutionListener;
...
import org.cadenzaflow.bpm.engine.impl.variable.listener.ClassDelegateCaseVariableListener;
import org.cadenzaflow.bpm.engine.impl.variable.listener.DelegateExpressionCaseVariableListener;
import org.cadenzaflow.bpm.engine.impl.variable.listener.ExpressionCaseVariableListener;
import org.cadenzaflow.bpm.engine.impl.variable.listener.ScriptCaseVariableListener;
import org.cadenzaflow.bpm.model.cmmn.Query;
import org.cadenzaflow.bpm.model.cmmn.instance.CmmnElement;
import org.cadenzaflow.bpm.model.cmmn.instance.ConditionExpression;
import org.cadenzaflow.bpm.model.cmmn.instance.DiscretionaryItem;
import org.cadenzaflow.bpm.model.cmmn.instance.Documentation;
import org.cadenzaflow.bpm.model.cmmn.instance.ExtensionElements;
import org.cadenzaflow.bpm.model.cmmn.instance.ManualActivationRule;
import org.cadenzaflow.bpm.model.cmmn.instance.PlanItem;
import org.cadenzaflow.bpm.model.cmmn.instance.PlanItemControl;
import org.cadenzaflow.bpm.model.cmmn.instance.PlanItemDefinition;
import org.cadenzaflow.bpm.model.cmmn.instance.RepetitionRule;
import org.cadenzaflow.bpm.model.cmmn.instance.RequiredRule;
import org.cadenzaflow.bpm.model.cmmn.instance.Sentry;
import org.cadenzaflow.bpm.model.cmmn.instance.camunda.CamundaCaseExecutionListener;
import org.cadenzaflow.bpm.model.cmmn.instance.camunda.CamundaExpression;
import org.cadenzaflow.bpm.model.cmmn.instance.camunda.CamundaField;
import org.cadenzaflow.bpm.model.cmmn.instance.camunda.CamundaScript;
import org.cadenzaflow.bpm.model.cmmn.instance.camunda.CamundaString;
import org.cadenzaflow.bpm.model.cmmn.instance.camunda.CamundaVariableListener;
