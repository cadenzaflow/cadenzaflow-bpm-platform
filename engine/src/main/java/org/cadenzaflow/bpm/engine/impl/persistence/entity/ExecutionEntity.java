...
import org.cadenzaflow.bpm.engine.impl.bpmn.parser.EventSubscriptionDeclaration;
...
import org.cadenzaflow.bpm.engine.impl.cfg.multitenancy.TenantIdProviderProcessInstanceContext;
import org.cadenzaflow.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionEntity;
...
import org.cadenzaflow.bpm.engine.impl.core.operation.CoreAtomicOperation;
import org.cadenzaflow.bpm.engine.impl.core.variable.CoreVariableInstance;
import org.cadenzaflow.bpm.engine.impl.core.variable.event.VariableEvent;
import org.cadenzaflow.bpm.engine.impl.core.variable.scope.VariableCollectionProvider;
import org.cadenzaflow.bpm.engine.impl.core.variable.scope.VariableInstanceFactory;
import org.cadenzaflow.bpm.engine.impl.core.variable.scope.VariableInstanceLifecycleListener;
import org.cadenzaflow.bpm.engine.impl.core.variable.scope.VariableListenerInvocationListener;
import org.cadenzaflow.bpm.engine.impl.core.variable.scope.VariableStore;
import org.cadenzaflow.bpm.engine.impl.core.variable.scope.VariableStore.VariablesProvider;
import org.cadenzaflow.bpm.engine.impl.db.DbEntity;
import org.cadenzaflow.bpm.engine.impl.db.EnginePersistenceLogger;
import org.cadenzaflow.bpm.engine.impl.db.HasDbReferences;
...
import org.cadenzaflow.bpm.engine.impl.history.event.HistoryEventProcessor;
...
import org.cadenzaflow.bpm.engine.impl.incident.IncidentHandling;
import org.cadenzaflow.bpm.engine.impl.interceptor.AtomicOperationInvocation;
...
import org.cadenzaflow.bpm.engine.impl.pvm.PvmActivity;
...
import org.cadenzaflow.bpm.engine.impl.pvm.runtime.ActivityInstanceState;
import org.cadenzaflow.bpm.engine.impl.pvm.runtime.AtomicOperation;
...
import org.cadenzaflow.bpm.engine.impl.tree.ExecutionTopDownWalker;
import org.cadenzaflow.bpm.engine.impl.tree.TreeVisitor;
import org.cadenzaflow.bpm.engine.impl.util.BitMaskUtil;
