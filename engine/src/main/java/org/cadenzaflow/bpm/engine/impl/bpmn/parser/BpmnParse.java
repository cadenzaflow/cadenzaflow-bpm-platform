...
import org.cadenzaflow.bpm.engine.ActivityTypes;
...
import org.cadenzaflow.bpm.engine.delegate.VariableListener;
import org.cadenzaflow.bpm.engine.impl.Condition;
import org.cadenzaflow.bpm.engine.impl.HistoryTimeToLiveParser;
import org.cadenzaflow.bpm.engine.impl.ProcessEngineLogger;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.BoundaryConditionalEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.BoundaryEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.CallActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.CallableElementActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.CancelBoundaryEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.CancelEndEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.CaseCallActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ClassDelegateActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.CompensationEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.DmnBusinessRuleTaskActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ErrorEndEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.EventBasedGatewayActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.EventSubProcessActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.EventSubProcessStartConditionalEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.EventSubProcessStartEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ExclusiveGatewayActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.InclusiveGatewayActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.IntermediateCatchEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.IntermediateCatchLinkEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.IntermediateConditionalEventBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.IntermediateThrowNoneEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.MailActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ManualTaskActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.MultiInstanceActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.NoneEndEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.NoneStartEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ParallelGatewayActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ParallelMultiInstanceActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ReceiveTaskActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ScriptTaskActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.SequentialMultiInstanceActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ServiceTaskDelegateExpressionActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ServiceTaskExpressionActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ShellActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.SubProcessActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.TaskActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.TerminateEndEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ThrowEscalationEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ThrowSignalEventActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.UserTaskActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.helper.BpmnProperties;
import org.cadenzaflow.bpm.engine.impl.bpmn.listener.ClassDelegateExecutionListener;
import org.cadenzaflow.bpm.engine.impl.bpmn.listener.DelegateExpressionExecutionListener;
import org.cadenzaflow.bpm.engine.impl.bpmn.listener.ExpressionExecutionListener;
import org.cadenzaflow.bpm.engine.impl.bpmn.listener.ScriptExecutionListener;
import org.cadenzaflow.bpm.engine.impl.context.Context;
import org.cadenzaflow.bpm.engine.impl.core.model.BaseCallableElement;
import org.cadenzaflow.bpm.engine.impl.core.model.BaseCallableElement.CallableElementBinding;
import org.cadenzaflow.bpm.engine.impl.core.model.CallableElement;
import org.cadenzaflow.bpm.engine.impl.core.model.CallableElementParameter;
import org.cadenzaflow.bpm.engine.impl.core.model.Properties;
import org.cadenzaflow.bpm.engine.impl.core.variable.mapping.IoMapping;
import org.cadenzaflow.bpm.engine.impl.core.variable.mapping.value.ConstantValueProvider;
import org.cadenzaflow.bpm.engine.impl.core.variable.mapping.value.NullValueProvider;
import org.cadenzaflow.bpm.engine.impl.core.variable.mapping.value.ParameterValueProvider;
import org.cadenzaflow.bpm.engine.impl.dmn.result.DecisionResultMapper;
import org.cadenzaflow.bpm.engine.impl.el.ElValueProvider;
import org.cadenzaflow.bpm.engine.impl.el.Expression;
import org.cadenzaflow.bpm.engine.impl.el.ExpressionManager;
import org.cadenzaflow.bpm.engine.impl.el.FixedValue;
import org.cadenzaflow.bpm.engine.impl.el.UelExpressionCondition;
import org.cadenzaflow.bpm.engine.impl.event.EventType;
import org.cadenzaflow.bpm.engine.impl.form.FormDefinition;
import org.cadenzaflow.bpm.engine.impl.form.handler.DefaultStartFormHandler;
import org.cadenzaflow.bpm.engine.impl.form.handler.DefaultTaskFormHandler;
import org.cadenzaflow.bpm.engine.impl.form.handler.DelegateStartFormHandler;
import org.cadenzaflow.bpm.engine.impl.form.handler.DelegateTaskFormHandler;
import org.cadenzaflow.bpm.engine.impl.form.handler.StartFormHandler;
import org.cadenzaflow.bpm.engine.impl.form.handler.TaskFormHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.AsyncAfterMessageJobDeclaration;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.AsyncBeforeMessageJobDeclaration;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.EventSubscriptionJobDeclaration;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.JobDeclaration;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.MessageJobDeclaration;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerCatchIntermediateEventJobHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerDeclarationImpl;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerDeclarationType;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerEventJobHandler;
...
import org.cadenzaflow.bpm.engine.impl.persistence.entity.JobEntity;
...
import org.cadenzaflow.bpm.engine.impl.pvm.process.ActivityStartBehavior;
import org.cadenzaflow.bpm.engine.impl.pvm.process.HasDIBounds;
import org.cadenzaflow.bpm.engine.impl.pvm.process.Lane;
import org.cadenzaflow.bpm.engine.impl.pvm.process.LaneSet;
import org.cadenzaflow.bpm.engine.impl.pvm.process.ParticipantProcess;
...
import org.cadenzaflow.bpm.engine.impl.pvm.process.TransitionImpl;
import org.cadenzaflow.bpm.engine.impl.pvm.runtime.LegacyBehavior;
import org.cadenzaflow.bpm.engine.impl.scripting.ExecutableScript;
import org.cadenzaflow.bpm.engine.impl.scripting.ScriptCondition;
import org.cadenzaflow.bpm.engine.impl.scripting.engine.ScriptingEngines;
import org.cadenzaflow.bpm.engine.impl.task.TaskDecorator;
import org.cadenzaflow.bpm.engine.impl.task.TaskDefinition;
import org.cadenzaflow.bpm.engine.impl.task.listener.ClassDelegateTaskListener;
import org.cadenzaflow.bpm.engine.impl.task.listener.DelegateExpressionTaskListener;
import org.cadenzaflow.bpm.engine.impl.task.listener.ExpressionTaskListener;
import org.cadenzaflow.bpm.engine.impl.task.listener.ScriptTaskListener;
import org.cadenzaflow.bpm.engine.impl.util.DecisionEvaluationUtil;
import org.cadenzaflow.bpm.engine.impl.util.ReflectUtil;
import org.cadenzaflow.bpm.engine.impl.util.ScriptUtil;
import org.cadenzaflow.bpm.engine.impl.util.StringUtil;
import org.cadenzaflow.bpm.engine.impl.util.xml.Element;
import org.cadenzaflow.bpm.engine.impl.util.xml.Namespace;
import org.cadenzaflow.bpm.engine.impl.util.xml.Parse;
import org.cadenzaflow.bpm.engine.impl.variable.VariableDeclaration;
...
public class BpmnParse extends Parse {
  ...
  public static final Namespace CAMUNDA_BPMN_EXTENSIONS_NS = new Namespace(BpmnParser.CADENZAFLOW_BPMN_EXTENSIONS_NS, BpmnParser.CAMUNDA_BPMN_EXTENSIONS_NS, BpmnParser.ACTIVITI_BPMN_EXTENSIONS_NS);
