...
import org.cadenzaflow.bpm.engine.batch.history.HistoricBatchQuery;
import org.cadenzaflow.bpm.engine.history.CleanableHistoricBatchReport;
import org.cadenzaflow.bpm.engine.history.CleanableHistoricCaseInstanceReport;
import org.cadenzaflow.bpm.engine.history.CleanableHistoricDecisionInstanceReport;
import org.cadenzaflow.bpm.engine.history.CleanableHistoricProcessInstanceReport;
import org.cadenzaflow.bpm.engine.history.HistoricActivityInstanceQuery;
import org.cadenzaflow.bpm.engine.history.HistoricActivityStatisticsQuery;
import org.cadenzaflow.bpm.engine.history.HistoricCaseActivityInstanceQuery;
import org.cadenzaflow.bpm.engine.history.HistoricCaseActivityStatisticsQuery;
import org.cadenzaflow.bpm.engine.history.HistoricCaseInstanceQuery;
import org.cadenzaflow.bpm.engine.history.HistoricDecisionInstanceQuery;
import org.cadenzaflow.bpm.engine.history.HistoricDecisionInstanceStatisticsQuery;
import org.cadenzaflow.bpm.engine.history.HistoricDetailQuery;
import org.cadenzaflow.bpm.engine.history.HistoricExternalTaskLogQuery;
import org.cadenzaflow.bpm.engine.history.HistoricIncidentQuery;
import org.cadenzaflow.bpm.engine.history.HistoricJobLogQuery;
import org.cadenzaflow.bpm.engine.history.HistoricProcessInstanceQuery;
import org.cadenzaflow.bpm.engine.history.HistoricProcessInstanceReport;
import org.cadenzaflow.bpm.engine.history.HistoricTaskInstanceQuery;
import org.cadenzaflow.bpm.engine.history.HistoricTaskInstanceReport;
import org.cadenzaflow.bpm.engine.history.HistoricVariableInstanceQuery;
import org.cadenzaflow.bpm.engine.history.NativeHistoricActivityInstanceQuery;
import org.cadenzaflow.bpm.engine.history.NativeHistoricCaseActivityInstanceQuery;
import org.cadenzaflow.bpm.engine.history.NativeHistoricCaseInstanceQuery;
import org.cadenzaflow.bpm.engine.history.NativeHistoricDecisionInstanceQuery;
import org.cadenzaflow.bpm.engine.history.NativeHistoricProcessInstanceQuery;
import org.cadenzaflow.bpm.engine.history.NativeHistoricTaskInstanceQuery;
import org.cadenzaflow.bpm.engine.history.NativeHistoricVariableInstanceQuery;
import org.cadenzaflow.bpm.engine.history.SetRemovalTimeSelectModeForHistoricBatchesBuilder;
import org.cadenzaflow.bpm.engine.history.SetRemovalTimeSelectModeForHistoricDecisionInstancesBuilder;
import org.cadenzaflow.bpm.engine.history.SetRemovalTimeSelectModeForHistoricProcessInstancesBuilder;
import org.cadenzaflow.bpm.engine.history.SetRemovalTimeToHistoricBatchesBuilder;
import org.cadenzaflow.bpm.engine.history.SetRemovalTimeToHistoricDecisionInstancesBuilder;
import org.cadenzaflow.bpm.engine.history.UserOperationLogQuery;
import org.cadenzaflow.bpm.engine.impl.batch.history.DeleteHistoricBatchCmd;
import org.cadenzaflow.bpm.engine.impl.batch.history.HistoricBatchQueryImpl;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteHistoricCaseInstanceCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteHistoricCaseInstancesBulkCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteHistoricProcessInstancesCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteHistoricTaskInstanceCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteHistoricVariableInstanceCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteHistoricVariableInstancesByProcessInstanceIdCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteUserOperationLogEntryCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.FindHistoryCleanupJobsCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetHistoricExternalTaskLogErrorDetailsCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetHistoricJobLogExceptionStacktraceCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.HistoryCleanupCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.batch.DeleteHistoricProcessInstancesBatchCmd;
import org.cadenzaflow.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByDefinitionIdCmd;
import org.cadenzaflow.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstanceByInstanceIdCmd;
import org.cadenzaflow.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstancesBatchCmd;
import org.cadenzaflow.bpm.engine.impl.dmn.cmd.DeleteHistoricDecisionInstancesBulkCmd;
import org.cadenzaflow.bpm.engine.history.SetRemovalTimeToHistoricProcessInstancesBuilder;
import org.cadenzaflow.bpm.engine.impl.history.SetRemovalTimeToHistoricBatchesBuilderImpl;
import org.cadenzaflow.bpm.engine.impl.history.SetRemovalTimeToHistoricDecisionInstancesBuilderImpl;
import org.cadenzaflow.bpm.engine.impl.history.SetRemovalTimeToHistoricProcessInstancesBuilderImpl;
