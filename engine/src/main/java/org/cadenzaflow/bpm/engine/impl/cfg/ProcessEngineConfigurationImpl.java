...
import org.cadenzaflow.bpm.dmn.engine.DmnEngineConfiguration;
import org.cadenzaflow.bpm.dmn.engine.impl.DefaultDmnEngineConfiguration;
import org.cadenzaflow.bpm.dmn.engine.impl.spi.el.ElProvider;
import org.cadenzaflow.bpm.dmn.feel.impl.scala.function.FeelCustomFunctionProvider;
import org.cadenzaflow.bpm.engine.ArtifactFactory;
...
import org.cadenzaflow.bpm.engine.impl.AuthorizationServiceImpl;
import org.cadenzaflow.bpm.engine.impl.DecisionServiceImpl;
import org.cadenzaflow.bpm.engine.impl.DefaultArtifactFactory;
import org.cadenzaflow.bpm.engine.impl.ExternalTaskServiceImpl;
import org.cadenzaflow.bpm.engine.impl.FilterServiceImpl;
import org.cadenzaflow.bpm.engine.impl.FormServiceImpl;
import org.cadenzaflow.bpm.engine.impl.HistoryServiceImpl;
import org.cadenzaflow.bpm.engine.impl.IdentityServiceImpl;
import org.cadenzaflow.bpm.engine.impl.ManagementServiceImpl;
import org.cadenzaflow.bpm.engine.impl.ModificationBatchJobHandler;
import org.cadenzaflow.bpm.engine.impl.OptimizeService;
import org.cadenzaflow.bpm.engine.impl.PriorityProvider;
import org.cadenzaflow.bpm.engine.impl.ProcessEngineImpl;
import org.cadenzaflow.bpm.engine.impl.ProcessEngineLogger;
import org.cadenzaflow.bpm.engine.impl.RepositoryServiceImpl;
import org.cadenzaflow.bpm.engine.impl.RestartProcessInstancesJobHandler;
import org.cadenzaflow.bpm.engine.impl.RuntimeServiceImpl;
import org.cadenzaflow.bpm.engine.impl.ServiceImpl;
import org.cadenzaflow.bpm.engine.impl.TaskServiceImpl;
import org.cadenzaflow.bpm.engine.impl.application.ProcessApplicationManager;
import org.cadenzaflow.bpm.engine.impl.batch.BatchJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.BatchMonitorJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.BatchSeedJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.deletion.DeleteHistoricProcessInstancesJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.deletion.DeleteProcessInstancesJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.externaltask.SetExternalTaskRetriesJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.job.SetJobRetriesJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.message.MessageCorrelationBatchJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.removaltime.BatchSetRemovalTimeJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.removaltime.DecisionSetRemovalTimeJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.removaltime.ProcessSetRemovalTimeJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.update.UpdateProcessInstancesSuspendStateJobHandler;
import org.cadenzaflow.bpm.engine.impl.batch.variables.BatchSetVariablesHandler;
import org.cadenzaflow.bpm.engine.impl.bpmn.behavior.ExternalTaskActivityBehavior;
import org.cadenzaflow.bpm.engine.impl.bpmn.deployer.BpmnDeployer;
import org.cadenzaflow.bpm.engine.impl.bpmn.parser.BpmnParseListener;
import org.cadenzaflow.bpm.engine.impl.bpmn.parser.BpmnParser;
import org.cadenzaflow.bpm.engine.impl.bpmn.parser.DefaultFailedJobParseListener;
import org.cadenzaflow.bpm.engine.impl.calendar.BusinessCalendarManager;
import org.cadenzaflow.bpm.engine.impl.calendar.CycleBusinessCalendar;
import org.cadenzaflow.bpm.engine.impl.calendar.DueDateBusinessCalendar;
import org.cadenzaflow.bpm.engine.impl.calendar.DurationBusinessCalendar;
import org.cadenzaflow.bpm.engine.impl.calendar.MapBusinessCalendarManager;
import org.cadenzaflow.bpm.engine.impl.cfg.auth.AuthorizationCommandChecker;
import org.cadenzaflow.bpm.engine.impl.cfg.auth.DefaultAuthorizationProvider;
import org.cadenzaflow.bpm.engine.impl.cfg.auth.DefaultPermissionProvider;
import org.cadenzaflow.bpm.engine.impl.cfg.auth.PermissionProvider;
import org.cadenzaflow.bpm.engine.impl.cfg.auth.ResourceAuthorizationProvider;
import org.cadenzaflow.bpm.engine.impl.cfg.multitenancy.TenantCommandChecker;
import org.cadenzaflow.bpm.engine.impl.cfg.multitenancy.TenantIdProvider;
import org.cadenzaflow.bpm.engine.impl.cfg.standalone.StandaloneTransactionContextFactory;
import org.cadenzaflow.bpm.engine.impl.cmd.HistoryCleanupCmd;
import org.cadenzaflow.bpm.engine.impl.cmmn.CaseServiceImpl;
import org.cadenzaflow.bpm.engine.impl.cmmn.deployer.CmmnDeployer;
import org.cadenzaflow.bpm.engine.impl.cmmn.entity.repository.CaseDefinitionManager;
import org.cadenzaflow.bpm.engine.impl.cmmn.entity.runtime.CaseExecutionManager;
import org.cadenzaflow.bpm.engine.impl.cmmn.entity.runtime.CaseSentryPartManager;
import org.cadenzaflow.bpm.engine.impl.cmmn.handler.DefaultCmmnElementHandlerRegistry;
import org.cadenzaflow.bpm.engine.impl.cmmn.transformer.CmmnTransformFactory;
import org.cadenzaflow.bpm.engine.impl.cmmn.transformer.CmmnTransformListener;
import org.cadenzaflow.bpm.engine.impl.cmmn.transformer.CmmnTransformer;
import org.cadenzaflow.bpm.engine.impl.cmmn.transformer.DefaultCmmnTransformFactory;
import org.cadenzaflow.bpm.engine.impl.db.DbIdGenerator;
import org.cadenzaflow.bpm.engine.impl.db.entitymanager.DbEntityManagerFactory;
import org.cadenzaflow.bpm.engine.impl.db.entitymanager.cache.DbEntityCacheKeyMapping;
import org.cadenzaflow.bpm.engine.impl.db.sql.DbSqlPersistenceProviderFactory;
import org.cadenzaflow.bpm.engine.impl.db.sql.DbSqlSessionFactory;
import org.cadenzaflow.bpm.engine.impl.delegate.DefaultDelegateInterceptor;
import org.cadenzaflow.bpm.engine.impl.diagnostics.DiagnosticsCollector;
import org.cadenzaflow.bpm.engine.impl.diagnostics.DiagnosticsRegistry;
import org.cadenzaflow.bpm.engine.impl.digest.Default16ByteSaltGenerator;
import org.cadenzaflow.bpm.engine.impl.digest.PasswordEncryptor;
import org.cadenzaflow.bpm.engine.impl.digest.PasswordManager;
import org.cadenzaflow.bpm.engine.impl.digest.SaltGenerator;
import org.cadenzaflow.bpm.engine.impl.digest.Sha512HashDigest;
import org.cadenzaflow.bpm.engine.impl.dmn.batch.DeleteHistoricDecisionInstancesJobHandler;
import org.cadenzaflow.bpm.engine.impl.dmn.configuration.DmnEngineConfigurationBuilder;
import org.cadenzaflow.bpm.engine.impl.dmn.deployer.DecisionDefinitionDeployer;
import org.cadenzaflow.bpm.engine.impl.dmn.deployer.DecisionRequirementsDefinitionDeployer;
import org.cadenzaflow.bpm.engine.impl.dmn.entity.repository.DecisionDefinitionManager;
import org.cadenzaflow.bpm.engine.impl.dmn.entity.repository.DecisionRequirementsDefinitionManager;
import org.cadenzaflow.bpm.engine.impl.el.CommandContextFunctions;
import org.cadenzaflow.bpm.engine.impl.el.DateTimeFunctions;
import org.cadenzaflow.bpm.engine.impl.el.ElProviderCompatible;
import org.cadenzaflow.bpm.engine.impl.el.ExpressionManager;
import org.cadenzaflow.bpm.engine.impl.el.JuelExpressionManager;
import org.cadenzaflow.bpm.engine.impl.errorcode.ExceptionCodeProvider;
import org.cadenzaflow.bpm.engine.impl.event.CompensationEventHandler;
import org.cadenzaflow.bpm.engine.impl.event.ConditionalEventHandler;
import org.cadenzaflow.bpm.engine.impl.event.EventHandler;
import org.cadenzaflow.bpm.engine.impl.event.EventHandlerImpl;
import org.cadenzaflow.bpm.engine.impl.event.EventType;
import org.cadenzaflow.bpm.engine.impl.event.SignalEventHandler;
import org.cadenzaflow.bpm.engine.impl.externaltask.DefaultExternalTaskPriorityProvider;
import org.cadenzaflow.bpm.engine.impl.form.deployer.CamundaFormDefinitionDeployer;
import org.cadenzaflow.bpm.engine.impl.form.engine.FormEngine;
import org.cadenzaflow.bpm.engine.impl.form.engine.HtmlFormEngine;
import org.cadenzaflow.bpm.engine.impl.form.engine.JuelFormEngine;
import org.cadenzaflow.bpm.engine.impl.form.entity.CamundaFormDefinitionManager;
import org.cadenzaflow.bpm.engine.impl.form.type.AbstractFormFieldType;
import org.cadenzaflow.bpm.engine.impl.form.type.BooleanFormType;
import org.cadenzaflow.bpm.engine.impl.form.type.DateFormType;
import org.cadenzaflow.bpm.engine.impl.form.type.FormTypes;
import org.cadenzaflow.bpm.engine.impl.form.type.LongFormType;
import org.cadenzaflow.bpm.engine.impl.form.type.StringFormType;
import org.cadenzaflow.bpm.engine.impl.form.validator.FormFieldValidator;
import org.cadenzaflow.bpm.engine.impl.form.validator.FormValidators;
import org.cadenzaflow.bpm.engine.impl.form.validator.MaxLengthValidator;
import org.cadenzaflow.bpm.engine.impl.form.validator.MaxValidator;
import org.cadenzaflow.bpm.engine.impl.form.validator.MinLengthValidator;
import org.cadenzaflow.bpm.engine.impl.form.validator.MinValidator;
import org.cadenzaflow.bpm.engine.impl.form.validator.ReadOnlyValidator;
import org.cadenzaflow.bpm.engine.impl.form.validator.RequiredValidator;
import org.cadenzaflow.bpm.engine.impl.history.DefaultHistoryRemovalTimeProvider;
import org.cadenzaflow.bpm.engine.impl.history.HistoryLevel;
import org.cadenzaflow.bpm.engine.impl.history.HistoryRemovalTimeProvider;
import org.cadenzaflow.bpm.engine.impl.history.event.HistoricDecisionInstanceManager;
import org.cadenzaflow.bpm.engine.impl.history.event.HostnameProvider;
import org.cadenzaflow.bpm.engine.impl.history.event.SimpleIpBasedProvider;
import org.cadenzaflow.bpm.engine.impl.history.handler.CompositeDbHistoryEventHandler;
import org.cadenzaflow.bpm.engine.impl.history.handler.CompositeHistoryEventHandler;
...
import org.cadenzaflow.bpm.engine.impl.history.parser.HistoryParseListener;
import org.cadenzaflow.bpm.engine.impl.history.producer.CacheAwareCmmnHistoryEventProducer;
import org.cadenzaflow.bpm.engine.impl.history.producer.CacheAwareHistoryEventProducer;
import org.cadenzaflow.bpm.engine.impl.history.producer.CmmnHistoryEventProducer;
import org.cadenzaflow.bpm.engine.impl.history.producer.DefaultDmnHistoryEventProducer;
import org.cadenzaflow.bpm.engine.impl.history.producer.DmnHistoryEventProducer;
import org.cadenzaflow.bpm.engine.impl.history.producer.HistoryEventProducer;
import org.cadenzaflow.bpm.engine.impl.history.transformer.CmmnHistoryTransformListener;
import org.cadenzaflow.bpm.engine.impl.identity.DefaultPasswordPolicyImpl;
import org.cadenzaflow.bpm.engine.impl.identity.ReadOnlyIdentityProvider;
import org.cadenzaflow.bpm.engine.impl.identity.WritableIdentityProvider;
import org.cadenzaflow.bpm.engine.impl.identity.db.DbIdentityServiceProvider;
import org.cadenzaflow.bpm.engine.impl.incident.CompositeIncidentHandler;
...
import org.cadenzaflow.bpm.engine.impl.interceptor.CommandContextFactory;
import org.cadenzaflow.bpm.engine.impl.interceptor.CommandExecutor;
import org.cadenzaflow.bpm.engine.impl.interceptor.CommandExecutorImpl;
import org.cadenzaflow.bpm.engine.impl.interceptor.CommandInterceptor;
import org.cadenzaflow.bpm.engine.impl.interceptor.DelegateInterceptor;
import org.cadenzaflow.bpm.engine.impl.interceptor.ExceptionCodeInterceptor;
import org.cadenzaflow.bpm.engine.impl.interceptor.SessionFactory;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.AsyncContinuationJobHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.DefaultFailedJobCommandFactory;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.DefaultJobExecutor;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.DefaultJobPriorityProvider;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.FailedJobCommandFactory;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.JobDeclaration;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.JobExecutor;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.JobHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.NotifyAcquisitionRejectedJobsHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.ProcessEventJobHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.RejectedJobsHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerActivateJobDefinitionHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerActivateProcessDefinitionHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerCatchIntermediateEventJobHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerExecuteNestedActivityJobHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerStartEventJobHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerStartEventSubprocessJobHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerSuspendJobDefinitionHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerSuspendProcessDefinitionHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.TimerTaskListenerJobHandler;
...
import org.cadenzaflow.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupBatch;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHandler;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupHelper;
import org.cadenzaflow.bpm.engine.impl.jobexecutor.historycleanup.HistoryCleanupJobHandler;
import org.cadenzaflow.bpm.engine.impl.metrics.MetricsRegistry;
import org.cadenzaflow.bpm.engine.impl.metrics.MetricsReporterIdProvider;
import org.cadenzaflow.bpm.engine.impl.metrics.parser.MetricsBpmnParseListener;
import org.cadenzaflow.bpm.engine.impl.metrics.parser.MetricsCmmnTransformListener;
import org.cadenzaflow.bpm.engine.impl.metrics.reporter.DbMetricsReporter;
import org.cadenzaflow.bpm.engine.impl.migration.DefaultMigrationActivityMatcher;
import org.cadenzaflow.bpm.engine.impl.migration.DefaultMigrationInstructionGenerator;
import org.cadenzaflow.bpm.engine.impl.migration.MigrationActivityMatcher;
import org.cadenzaflow.bpm.engine.impl.migration.MigrationInstructionGenerator;
import org.cadenzaflow.bpm.engine.impl.migration.batch.MigrationBatchJobHandler;
import org.cadenzaflow.bpm.engine.impl.migration.validation.activity.MigrationActivityValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.activity.NoCompensationHandlerActivityValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.activity.SupportedActivityValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.activity.SupportedPassiveEventTriggerActivityValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.AsyncAfterMigrationValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.AsyncMigrationValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.AsyncProcessStartMigrationValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.MigratingActivityInstanceValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.MigratingCompensationInstanceValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.MigratingTransitionInstanceValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.NoUnmappedCompensationStartEventValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.NoUnmappedLeafInstanceValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.SupportedActivityInstanceValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instance.VariableConflictActivityInstanceValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.AdditionalFlowScopeInstructionValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceBodyValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.CannotAddMultiInstanceInnerActivityValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.CannotRemoveMultiInstanceInnerActivityValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.ConditionalEventUpdateEventTriggerValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.GatewayMappingValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.MigrationInstructionValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.OnlyOnceMappedActivityInstructionValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.SameBehaviorInstructionValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.SameEventScopeInstructionValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.SameEventTypeValidator;
import org.cadenzaflow.bpm.engine.impl.migration.validation.instruction.UpdateEventTriggersValidator;
import org.cadenzaflow.bpm.engine.impl.optimize.OptimizeManager;
import org.cadenzaflow.bpm.engine.impl.persistence.GenericManagerFactory;
import org.cadenzaflow.bpm.engine.impl.persistence.deploy.Deployer;
import org.cadenzaflow.bpm.engine.impl.persistence.deploy.cache.CacheFactory;
import org.cadenzaflow.bpm.engine.impl.persistence.deploy.cache.DefaultCacheFactory;
import org.cadenzaflow.bpm.engine.impl.persistence.deploy.cache.DeploymentCache;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.AttachmentManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.AuthorizationManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.BatchManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.ByteArrayManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.CommentManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.DeploymentManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.EventSubscriptionManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.ExecutionManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.ExternalTaskManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.FilterManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricActivityInstanceManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricBatchManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricCaseActivityInstanceManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricCaseInstanceManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricDetailManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricExternalTaskLogManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricIdentityLinkLogManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricIncidentManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricJobLogManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricProcessInstanceManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricStatisticsManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricTaskInstanceManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.HistoricVariableInstanceManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.IdentityInfoManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.IdentityLinkManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.IncidentManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.JobDefinitionManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.JobManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.MeterLogManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.ProcessDefinitionManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.PropertyManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.ReportManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.ResourceManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.SchemaLogManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.StatisticsManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.TableDataManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.TaskManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.TaskReportManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.TenantManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.UserOperationLogManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.VariableInstanceManager;
import org.cadenzaflow.bpm.engine.impl.repository.DefaultDeploymentHandlerFactory;
import org.cadenzaflow.bpm.engine.impl.runtime.ConditionHandler;
import org.cadenzaflow.bpm.engine.impl.runtime.CorrelationHandler;
import org.cadenzaflow.bpm.engine.impl.runtime.DefaultConditionHandler;
import org.cadenzaflow.bpm.engine.impl.runtime.DefaultCorrelationHandler;
import org.cadenzaflow.bpm.engine.impl.runtime.DefaultDeserializationTypeValidator;
import org.cadenzaflow.bpm.engine.impl.scripting.ScriptFactory;
import org.cadenzaflow.bpm.engine.impl.scripting.engine.BeansResolverFactory;
import org.cadenzaflow.bpm.engine.impl.scripting.engine.CamundaScriptEngineManager;
import org.cadenzaflow.bpm.engine.impl.scripting.engine.DefaultScriptEngineResolver;
import org.cadenzaflow.bpm.engine.impl.scripting.engine.ResolverFactory;
import org.cadenzaflow.bpm.engine.impl.scripting.engine.ScriptBindingsFactory;
...
import org.cadenzaflow.bpm.engine.impl.scripting.engine.VariableScopeResolverFactory;
...
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.DatabaseImpl;
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.InternalsImpl;
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.JdkImpl;
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.ProductImpl;
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.TelemetryDataImpl;
import org.cadenzaflow.bpm.engine.impl.util.ClockUtil;
import org.cadenzaflow.bpm.engine.impl.util.IoUtil;
import org.cadenzaflow.bpm.engine.impl.util.ParseUtil;
import org.cadenzaflow.bpm.engine.impl.util.ProcessEngineDetails;
import org.cadenzaflow.bpm.engine.impl.util.ReflectUtil;
import org.cadenzaflow.bpm.engine.impl.variable.ValueTypeResolverImpl;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.BooleanValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.ByteArrayValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.DateValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.DefaultVariableSerializers;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.DoubleValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.FileValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.IntegerValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.JavaObjectSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.LongValueSerlializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.NullValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.ShortValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.StringValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.TypedValueSerializer;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.VariableSerializerFactory;
import org.cadenzaflow.bpm.engine.impl.variable.serializer.VariableSerializers;
import org.cadenzaflow.bpm.engine.management.Metrics;
import org.cadenzaflow.bpm.engine.repository.CaseDefinition;
import org.cadenzaflow.bpm.engine.repository.DecisionDefinition;
import org.cadenzaflow.bpm.engine.repository.DecisionRequirementsDefinition;
import org.cadenzaflow.bpm.engine.repository.DeploymentBuilder;
import org.cadenzaflow.bpm.engine.repository.DeploymentHandlerFactory;
import org.cadenzaflow.bpm.engine.runtime.Incident;
import org.cadenzaflow.bpm.engine.runtime.WhitelistingDeserializationTypeValidator;
import org.cadenzaflow.bpm.engine.task.TaskQuery;
import org.cadenzaflow.bpm.engine.test.mock.MocksResolverFactory;
...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
  ...
  protected static final String PRODUCT_NAME = "CadenzaFlow BPM Runtime";
