...
import org.cadenzaflow.bpm.engine.authorization.MissingAuthorization;
...
import org.cadenzaflow.bpm.engine.impl.ActivityStatisticsQueryImpl;
import org.cadenzaflow.bpm.engine.impl.AuthorizationQueryImpl;
import org.cadenzaflow.bpm.engine.impl.DeploymentQueryImpl;
import org.cadenzaflow.bpm.engine.impl.DeploymentStatisticsQueryImpl;
import org.cadenzaflow.bpm.engine.impl.EventSubscriptionQueryImpl;
import org.cadenzaflow.bpm.engine.impl.ExternalTaskQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricActivityInstanceQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricDecisionInstanceQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricDetailQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricExternalTaskLogQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricIdentityLinkLogQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricIncidentQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricJobLogQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricProcessInstanceQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricTaskInstanceQueryImpl;
import org.cadenzaflow.bpm.engine.impl.HistoricVariableInstanceQueryImpl;
import org.cadenzaflow.bpm.engine.impl.IncidentQueryImpl;
import org.cadenzaflow.bpm.engine.impl.JobDefinitionQueryImpl;
import org.cadenzaflow.bpm.engine.impl.JobQueryImpl;
import org.cadenzaflow.bpm.engine.impl.ProcessDefinitionQueryImpl;
import org.cadenzaflow.bpm.engine.impl.ProcessDefinitionStatisticsQueryImpl;
import org.cadenzaflow.bpm.engine.impl.ProcessEngineLogger;
import org.cadenzaflow.bpm.engine.impl.TaskQueryImpl;
import org.cadenzaflow.bpm.engine.impl.UserOperationLogQueryImpl;
...
import org.cadenzaflow.bpm.engine.impl.db.AuthorizationCheck;
import org.cadenzaflow.bpm.engine.impl.db.CompositePermissionCheck;
import org.cadenzaflow.bpm.engine.impl.db.DbEntity;
import org.cadenzaflow.bpm.engine.impl.db.EnginePersistenceLogger;
import org.cadenzaflow.bpm.engine.impl.db.ListQueryParameterObject;
import org.cadenzaflow.bpm.engine.impl.db.PermissionCheck;
import org.cadenzaflow.bpm.engine.impl.db.PermissionCheckBuilder;
import org.cadenzaflow.bpm.engine.impl.db.entitymanager.operation.DbOperation;
...
import org.cadenzaflow.bpm.engine.impl.persistence.AbstractManager;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.util.AuthManagerUtil;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.util.AuthManagerUtil.VariablePermissions;
import org.cadenzaflow.bpm.engine.impl.util.ResourceTypeUtil;
