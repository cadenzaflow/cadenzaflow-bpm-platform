...
import org.cadenzaflow.bpm.engine.impl.cmd.AddCommentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.AddGroupIdentityLinkCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.AddUserIdentityLinkCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.AssignTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.ClaimTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.CompleteTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.CreateAttachmentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.CreateTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DelegateTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteAttachmentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteGroupIdentityLinkCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteProcessInstanceCommentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteTaskCommentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.DeleteUserIdentityLinkCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetAttachmentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetAttachmentContentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetIdentityLinksForTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetProcessInstanceAttachmentsCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetProcessInstanceCommentsCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetSubTasksCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskAttachmentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskAttachmentContentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskAttachmentsCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskCommentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskCommentsCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskEventsCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskVariableCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskVariableCmdTyped;
import org.cadenzaflow.bpm.engine.impl.cmd.GetTaskVariablesCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.HandleTaskBpmnErrorCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.HandleTaskEscalationCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.PatchTaskVariablesCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.RemoveTaskVariablesCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.ResolveTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SaveAttachmentCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SaveTaskCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SetTaskDescriptionCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SetTaskDueDateCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SetTaskFollowUpDateCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SetTaskNameCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SetTaskOwnerCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SetTaskPriorityCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.SetTaskVariablesCmd;
import org.cadenzaflow.bpm.engine.impl.cmd.UpdateCommentCmd;
import org.cadenzaflow.bpm.engine.impl.util.ExceptionUtil;
import org.cadenzaflow.bpm.engine.task.Attachment;
import org.cadenzaflow.bpm.engine.task.Comment;
import org.cadenzaflow.bpm.engine.task.Event;
import org.cadenzaflow.bpm.engine.task.IdentityLink;
import org.cadenzaflow.bpm.engine.task.IdentityLinkType;
import org.cadenzaflow.bpm.engine.task.NativeTaskQuery;
import org.cadenzaflow.bpm.engine.task.Task;
import org.cadenzaflow.bpm.engine.task.TaskQuery;
import org.cadenzaflow.bpm.engine.task.TaskReport;
