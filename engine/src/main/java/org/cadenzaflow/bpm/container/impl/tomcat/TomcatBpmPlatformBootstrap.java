 ...
 */
package org.cadenzaflow.bpm.container.impl.tomcat;
...
import org.cadenzaflow.bpm.container.impl.deployment.jobexecutor.StartManagedThreadPoolStep;
import org.cadenzaflow.bpm.container.impl.deployment.jobexecutor.StopJobExecutorStep;
import org.cadenzaflow.bpm.container.impl.deployment.jobexecutor.StopManagedThreadPoolStep;
import org.cadenzaflow.bpm.container.impl.tomcat.deployment.TomcatAttachments;
import org.cadenzaflow.bpm.container.impl.tomcat.deployment.TomcatParseBpmPlatformXmlStep;
import org.cadenzaflow.bpm.engine.ProcessEngine;
import org.cadenzaflow.bpm.engine.impl.ProcessEngineLogger;

/**
 * <p>Apache Tomcat server listener responsible for deploying the CadenzaFlow Platform.</p>
 *
 * @author Daniel Meyer
 *
 */
public class TomcatBpmPlatformBootstrap implements LifecycleListener {
  ...
  protected void deployBpmPlatform(LifecycleEvent event) {
    ...
    LOG.cadenzaflowBpmPlatformSuccessfullyStarted(server.getServerInfo());
  ...
  protected void undeployBpmPlatform(LifecycleEvent event) {
    ...
    LOG.cadenzaflowBpmPlatformStopped(server.getServerInfo());
  }
