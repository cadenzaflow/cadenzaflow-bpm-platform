...
public class HistoryCleanupOnEngineBootstrapTest {
  ...
  public void testConsecutiveEngineBootstrapHistoryCleanupJobReconfiguration() {
    ...
    ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cadenzaflow/bpm/engine/test/history/batchwindow.cadenzaflow.cfg.xml")
      .buildProcessEngine()
      .close();
    ...
    ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cadenzaflow/bpm/engine/test/history/no-batchwindow.cadenzaflow.cfg.xml")
      .buildProcessEngine()
      .close();
  ...
  public void testDecreaseNumberOfHistoryCleanupJobs() {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cadenzaflow/bpm/engine/test/history/history-cleanup-parallelism-default.cadenzaflow.cfg.xml")
      .buildProcessEngine();
    ...
    .createProcessEngineConfigurationFromResource("org/cadenzaflow/bpm/engine/test/history/history-cleanup-parallelism-less.cadenzaflow.cfg.xml")
      .buildProcessEngine();
  ...
  public void testIncreaseNumberOfHistoryCleanupJobs() {
    ...
    // when
    engine = ProcessEngineConfiguration
    .createProcessEngineConfigurationFromResource("org/cadenzaflow/bpm/engine/test/history/history-cleanup-parallelism-more.cadenzaflow.cfg.xml")
      .buildProcessEngine();
  ...
  public void testBatchWindowXmlConfigParsingException() throws ParseException {
    ...
    assertThatThrownBy(() -> ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cadenzaflow/bpm/engine/test/history/history-cleanup-batch-window-map-wrong-values.cadenzaflow.cfg.xml")
      .buildProcessEngine())
  ...
  public void testBatchWindowMapInXmlConfig() throws ParseException {
    ...
    ProcessEngine engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cadenzaflow/bpm/engine/test/history/history-cleanup-batch-window-map.cadenzaflow.cfg.xml")
      .buildProcessEngine();
    ...
    engine = ProcessEngineConfiguration
      .createProcessEngineConfigurationFromResource("org/cadenzaflow/bpm/engine/test/history/history-cleanup-batch-window-default.cadenzaflow.cfg.xml")
      .buildProcessEngine();
