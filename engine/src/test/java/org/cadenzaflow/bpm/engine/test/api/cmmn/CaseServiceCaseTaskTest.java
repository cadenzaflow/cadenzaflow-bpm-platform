...
public class CaseServiceCaseTaskTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
      "org/cadenzaflow/bpm/engine/test/api/cmmn/oneCaseTaskAndOneHumanTaskCaseWithManualActivation.cmmn",
      "org/cadenzaflow/bpm/engine/test/api/cmmn/oneTaskCase.cmmn"
      })
  @Test
  ...
  @Deployment(resources={"org/cadenzaflow/bpm/engine/test/api/cmmn/oneCaseTaskAndOneHumanTaskCaseWithManualActivation.cmmn"})
  @Test
