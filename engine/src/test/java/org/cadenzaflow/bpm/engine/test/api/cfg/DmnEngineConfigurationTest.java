 ...
 */
package org.cadenzaflow.bpm.engine.test.api.cfg;
...
public class DmnEngineConfigurationTest {
  ...
  protected final static String CONFIGURATION_XML = "org/cadenzaflow/bpm/engine/test/api/cfg/custom-dmn-cadenzaflow.cfg.xml";
