...
public class CaseServiceProcessTaskTest extends PluggableProcessEngineTest {
  ...
  @Deployment(resources={
      "org/cadenzaflow/bpm/engine/test/api/cmmn/oneProcessTaskWithManualActivationAndOneHumanTaskCase.cmmn",
      "org/cadenzaflow/bpm/engine/test/api/oneTaskProcess.bpmn20.xml"
      })
  @Test
  ...
  @Deployment(resources={"org/cadenzaflow/bpm/engine/test/api/cmmn/oneProcessTaskWithManualActivationAndOneHumanTaskCase.cmmn"})
  @Test
