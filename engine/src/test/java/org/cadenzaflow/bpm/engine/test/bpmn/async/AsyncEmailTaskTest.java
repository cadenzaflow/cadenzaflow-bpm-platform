...
import org.cadenzaflow.bpm.engine.test.bpmn.mail.EmailServiceTaskTest;
import org.cadenzaflow.bpm.engine.test.bpmn.mail.EmailTestCase;
...
public class AsyncEmailTaskTest extends EmailTestCase {
  ...
  // copied from org.cadenzaflow.bpm.engine.test.bpmn.mail.EmailServiceTaskTest
  @Deployment
  public void testSimpleTextMail() throws Exception {
    ...
    EmailServiceTaskTest.assertEmailSend(message, false, "Hello Kermit!", "This a text only e-mail.", "cadenzaflow@localhost",
            Arrays.asList("kermit@cadenzaflow.org"), null);
    testRule.assertProcessEnded(procId);
  }

  // copied from org.cadenzaflow.bpm.engine.test.bpmn.mail.EmailSendTaskTest
  @Deployment
