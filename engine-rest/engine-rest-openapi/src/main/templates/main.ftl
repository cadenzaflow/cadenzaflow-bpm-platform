...
<#assign docsUrl = "https://docs.cadenzaflow.org/manual/${docsVersion}">
{
  "openapi": "3.0.2",
  "info": {
    "title": "CadenzaFlow Platform REST API",
    "description": "OpenApi Spec for CadenzaFlow Platform REST API.",
  ...
  "externalDocs": {
    "description": "Find out more about CadenzaFlow Rest API",
