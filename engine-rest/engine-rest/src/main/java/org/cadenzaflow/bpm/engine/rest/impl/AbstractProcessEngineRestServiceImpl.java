...
import org.cadenzaflow.bpm.engine.rest.AuthorizationRestService;
import org.cadenzaflow.bpm.engine.rest.BatchRestService;
import org.cadenzaflow.bpm.engine.rest.CaseDefinitionRestService;
import org.cadenzaflow.bpm.engine.rest.CaseExecutionRestService;
import org.cadenzaflow.bpm.engine.rest.CaseInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.ConditionRestService;
import org.cadenzaflow.bpm.engine.rest.DecisionDefinitionRestService;
import org.cadenzaflow.bpm.engine.rest.DecisionRequirementsDefinitionRestService;
import org.cadenzaflow.bpm.engine.rest.DeploymentRestService;
import org.cadenzaflow.bpm.engine.rest.EventSubscriptionRestService;
import org.cadenzaflow.bpm.engine.rest.ExecutionRestService;
import org.cadenzaflow.bpm.engine.rest.ExternalTaskRestService;
import org.cadenzaflow.bpm.engine.rest.FilterRestService;
import org.cadenzaflow.bpm.engine.rest.GroupRestService;
import org.cadenzaflow.bpm.engine.rest.IdentityRestService;
import org.cadenzaflow.bpm.engine.rest.IncidentRestService;
import org.cadenzaflow.bpm.engine.rest.JobDefinitionRestService;
import org.cadenzaflow.bpm.engine.rest.JobRestService;
import org.cadenzaflow.bpm.engine.rest.MessageRestService;
import org.cadenzaflow.bpm.engine.rest.MetricsRestService;
import org.cadenzaflow.bpm.engine.rest.MigrationRestService;
import org.cadenzaflow.bpm.engine.rest.ModificationRestService;
import org.cadenzaflow.bpm.engine.rest.ProcessDefinitionRestService;
import org.cadenzaflow.bpm.engine.rest.ProcessInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.SchemaLogRestService;
import org.cadenzaflow.bpm.engine.rest.SignalRestService;
import org.cadenzaflow.bpm.engine.rest.TaskRestService;
import org.cadenzaflow.bpm.engine.rest.TelemetryRestService;
import org.cadenzaflow.bpm.engine.rest.TenantRestService;
import org.cadenzaflow.bpm.engine.rest.UserRestService;
import org.cadenzaflow.bpm.engine.rest.VariableInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoryRestService;
import org.cadenzaflow.bpm.engine.rest.impl.history.HistoryRestServiceImpl;
import org.cadenzaflow.bpm.engine.rest.impl.optimize.OptimizeRestService;
import org.cadenzaflow.bpm.engine.rest.util.ProvidersUtil;
