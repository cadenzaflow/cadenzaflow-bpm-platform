 ...
 */
package org.cadenzaflow.bpm.engine.rest.impl.history;

import org.cadenzaflow.bpm.engine.rest.history.HistoricActivityInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricProcessDefinitionRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricBatchRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricCaseActivityInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricCaseDefinitionRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricCaseInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricDecisionDefinitionRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricDecisionInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricDecisionStatisticsRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricDetailRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricExternalTaskLogRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricIdentityLinkLogRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricIncidentRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricJobLogRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricProcessInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricTaskInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoricVariableInstanceRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoryCleanupRestService;
import org.cadenzaflow.bpm.engine.rest.history.HistoryRestService;
import org.cadenzaflow.bpm.engine.rest.history.UserOperationLogRestService;

import org.cadenzaflow.bpm.engine.rest.impl.AbstractRestProcessEngineAware;
