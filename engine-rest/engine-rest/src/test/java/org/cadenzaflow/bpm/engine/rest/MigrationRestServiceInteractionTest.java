...
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_ACTIVITY_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_DEFINITION_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.ANOTHER_EXAMPLE_PROCESS_INSTANCE_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOBS_PER_SEED;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_JOB_DEFINITION_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TOTAL_JOBS;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_BATCH_TYPE;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_INVOCATIONS_PER_BATCH_JOB;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_MONITOR_JOB_DEFINITION_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_SEED_JOB_DEFINITION_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.EXAMPLE_TENANT_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.NON_EXISTING_ACTIVITY_ID;
import static org.cadenzaflow.bpm.engine.rest.helper.MockProvider.NON_EXISTING_PROCESS_DEFINITION_ID;
...
import static org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.*;
...
import org.cadenzaflow.bpm.engine.migration.MigratingActivityInstanceValidationReport;
import org.cadenzaflow.bpm.engine.migration.MigratingProcessInstanceValidationException;
import org.cadenzaflow.bpm.engine.migration.MigratingProcessInstanceValidationReport;
import org.cadenzaflow.bpm.engine.migration.MigratingTransitionInstanceValidationReport;
import org.cadenzaflow.bpm.engine.migration.MigrationInstruction;
import org.cadenzaflow.bpm.engine.migration.MigrationInstructionValidationReport;
import org.cadenzaflow.bpm.engine.migration.MigrationPlan;
import org.cadenzaflow.bpm.engine.migration.MigrationPlanBuilder;
import org.cadenzaflow.bpm.engine.migration.MigrationPlanExecutionBuilder;
import org.cadenzaflow.bpm.engine.migration.MigrationPlanValidationException;
import org.cadenzaflow.bpm.engine.migration.MigrationPlanValidationReport;
import org.cadenzaflow.bpm.engine.migration.MigrationVariableValidationReport;
import org.cadenzaflow.bpm.engine.rest.dto.VariableValueDto;
import org.cadenzaflow.bpm.engine.rest.dto.migration.MigrationInstructionDto;
import org.cadenzaflow.bpm.engine.rest.dto.runtime.ProcessInstanceQueryDto;
import org.cadenzaflow.bpm.engine.rest.helper.FluentAnswer;
import org.cadenzaflow.bpm.engine.rest.helper.MockMigrationPlanBuilder;
import org.cadenzaflow.bpm.engine.rest.helper.MockMigrationPlanBuilder.JoinedMigrationPlanBuilderMock;
import org.cadenzaflow.bpm.engine.rest.util.container.TestContainerRule;
import org.cadenzaflow.bpm.engine.rest.util.migration.MigrationExecutionDtoBuilder;
import org.cadenzaflow.bpm.engine.rest.util.migration.MigrationPlanDtoBuilder;
...
import org.cadenzaflow.bpm.engine.rest.util.migration.MigrationInstructionDtoBuilder;
