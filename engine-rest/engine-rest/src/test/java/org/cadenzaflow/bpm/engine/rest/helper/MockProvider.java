...
import org.cadenzaflow.bpm.application.ProcessApplicationInfo;
import org.cadenzaflow.bpm.dmn.engine.DmnDecisionResult;
import org.cadenzaflow.bpm.engine.EntityTypes;
...
import org.cadenzaflow.bpm.engine.batch.BatchStatistics;
import org.cadenzaflow.bpm.engine.batch.history.HistoricBatch;
import org.cadenzaflow.bpm.engine.exception.NotValidException;
...
import org.cadenzaflow.bpm.engine.filter.Filter;
import org.cadenzaflow.bpm.engine.filter.FilterQuery;
import org.cadenzaflow.bpm.engine.form.FormField;
import org.cadenzaflow.bpm.engine.form.FormProperty;
import org.cadenzaflow.bpm.engine.form.FormType;
import org.cadenzaflow.bpm.engine.form.StartFormData;
import org.cadenzaflow.bpm.engine.form.TaskFormData;
import org.cadenzaflow.bpm.engine.history.DurationReportResult;
import org.cadenzaflow.bpm.engine.history.HistoricActivityInstance;
import org.cadenzaflow.bpm.engine.history.HistoricActivityStatistics;
import org.cadenzaflow.bpm.engine.history.HistoricCaseActivityInstance;
import org.cadenzaflow.bpm.engine.history.HistoricCaseActivityStatistics;
import org.cadenzaflow.bpm.engine.history.HistoricCaseInstance;
import org.cadenzaflow.bpm.engine.history.HistoricDecisionInputInstance;
import org.cadenzaflow.bpm.engine.history.HistoricDecisionInstance;
import org.cadenzaflow.bpm.engine.history.HistoricDecisionInstanceStatistics;
import org.cadenzaflow.bpm.engine.history.HistoricDecisionOutputInstance;
import org.cadenzaflow.bpm.engine.history.HistoricDetail;
import org.cadenzaflow.bpm.engine.history.HistoricExternalTaskLog;
import org.cadenzaflow.bpm.engine.history.HistoricFormField;
import org.cadenzaflow.bpm.engine.history.HistoricIdentityLinkLog;
import org.cadenzaflow.bpm.engine.history.HistoricIncident;
import org.cadenzaflow.bpm.engine.history.HistoricJobLog;
...
import org.cadenzaflow.bpm.engine.history.HistoricTaskInstanceReportResult;
import org.cadenzaflow.bpm.engine.history.HistoricVariableInstance;
import org.cadenzaflow.bpm.engine.history.HistoricVariableUpdate;
import org.cadenzaflow.bpm.engine.history.UserOperationLogEntry;
...
import org.cadenzaflow.bpm.engine.impl.TaskQueryImpl;
import org.cadenzaflow.bpm.engine.impl.calendar.DateTimeUtil;
import org.cadenzaflow.bpm.engine.impl.form.CamundaFormRefImpl;
import org.cadenzaflow.bpm.engine.impl.identity.Authentication;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.MetricIntervalEntity;
import org.cadenzaflow.bpm.engine.impl.persistence.entity.ResourceEntity;
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.ApplicationServerImpl;
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.CommandImpl;
...
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.LicenseKeyDataImpl;
import org.cadenzaflow.bpm.engine.impl.telemetry.dto.MetricImpl;
...
import org.cadenzaflow.bpm.engine.management.ActivityStatistics;
import org.cadenzaflow.bpm.engine.management.IncidentStatistics;
import org.cadenzaflow.bpm.engine.management.JobDefinition;
import org.cadenzaflow.bpm.engine.management.MetricIntervalValue;
import org.cadenzaflow.bpm.engine.management.MetricsQuery;
import org.cadenzaflow.bpm.engine.management.ProcessDefinitionStatistics;
import org.cadenzaflow.bpm.engine.management.SetJobRetriesBuilder;
import org.cadenzaflow.bpm.engine.management.SetJobRetriesByJobsAsyncBuilder;
import org.cadenzaflow.bpm.engine.management.SetJobRetriesByProcessAsyncBuilder;
import org.cadenzaflow.bpm.engine.query.PeriodUnit;
import org.cadenzaflow.bpm.engine.query.Query;
...
import org.cadenzaflow.bpm.engine.repository.DeploymentWithDefinitions;
import org.cadenzaflow.bpm.engine.repository.ProcessDefinition;
import org.cadenzaflow.bpm.engine.repository.Resource;
import org.cadenzaflow.bpm.engine.rest.dto.task.TaskQueryDto;
...
import org.cadenzaflow.bpm.engine.runtime.MessageCorrelationResultType;
import org.cadenzaflow.bpm.engine.runtime.MessageCorrelationResultWithVariables;
import org.cadenzaflow.bpm.engine.runtime.ProcessInstance;
import org.cadenzaflow.bpm.engine.runtime.ProcessInstanceWithVariables;
...
import org.cadenzaflow.bpm.engine.task.DelegationState;
import org.cadenzaflow.bpm.engine.task.IdentityLink;
import org.cadenzaflow.bpm.engine.task.IdentityLinkType;
import org.cadenzaflow.bpm.engine.task.Task;
import org.cadenzaflow.bpm.engine.task.TaskCountByCandidateGroupResult;
import org.cadenzaflow.bpm.engine.variable.VariableMap;
import org.cadenzaflow.bpm.engine.variable.Variables;
import org.cadenzaflow.bpm.engine.variable.impl.value.ObjectValueImpl;
