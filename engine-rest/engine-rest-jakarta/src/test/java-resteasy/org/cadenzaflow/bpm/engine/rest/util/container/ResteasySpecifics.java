 ...
 */
package org.cadenzaflow.bpm.engine.rest.util.container;
...
import org.cadenzaflow.bpm.engine.rest.CustomJacksonDateFormatTest;
import org.cadenzaflow.bpm.engine.rest.ExceptionHandlerTest;
import org.cadenzaflow.bpm.engine.rest.application.TestCustomResourceApplication;
import org.cadenzaflow.bpm.engine.rest.security.auth.ProcessEngineAuthenticationFilter;
import org.cadenzaflow.bpm.engine.rest.standalone.NoServletAuthenticationFilterTest;
import org.cadenzaflow.bpm.engine.rest.standalone.NoServletEmptyBodyFilterTest;
import org.cadenzaflow.bpm.engine.rest.standalone.ServletAuthenticationFilterTest;
import org.cadenzaflow.bpm.engine.rest.standalone.ServletEmptyBodyFilterTest;
  ...
  static {
    ...
    TEST_RULE_FACTORIES.put(CustomJacksonDateFormatTest.class, new UndertowServletContainerRuleFactory(
        Servlets.deployment()
            ...
            .setClassLoader(ResteasyUndertowServerBootstrap.class.getClassLoader())
            .addListener(Servlets.listener(ResteasyBootstrap.class))
            .addListener(Servlets.listener(org.cadenzaflow.bpm.engine.rest.CustomJacksonDateFormatListener.class))
            .addInitParameter("org.cadenzaflow.bpm.engine.rest.jackson.dateFormat", "yyyy-MM-dd'T'HH:mm:ss")
            .addFilter(Servlets.filter("Resteasy", FilterDispatcher.class)
                .addInitParam("jakarta.ws.rs.Application",
                    "org.cadenzaflow.bpm.engine.rest.util.container.JaxrsApplication"))
            .addFilterUrlMapping("Resteasy", "/*", DispatcherType.REQUEST)));
