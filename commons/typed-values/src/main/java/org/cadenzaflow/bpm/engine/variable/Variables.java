 ...
 */
package org.cadenzaflow.bpm.engine.variable;
...
import org.cadenzaflow.bpm.engine.variable.impl.context.EmptyVariableContext;
import org.cadenzaflow.bpm.engine.variable.impl.value.AbstractTypedValue;
import org.cadenzaflow.bpm.engine.variable.impl.value.FileValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.NullValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.UntypedValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.BooleanValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.BytesValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.DateValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.DoubleValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.IntegerValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.LongValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.NumberValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.ShortValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.PrimitiveTypeValueImpl.StringValueImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.builder.FileValueBuilderImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.builder.ObjectVariableBuilderImpl;
import org.cadenzaflow.bpm.engine.variable.impl.value.builder.SerializedObjectValueBuilderImpl;
...
import org.cadenzaflow.bpm.engine.variable.value.DoubleValue;
...
import org.cadenzaflow.bpm.engine.variable.value.NumberValue;
import org.cadenzaflow.bpm.engine.variable.value.ObjectValue;
import org.cadenzaflow.bpm.engine.variable.value.SerializationDataFormat;
import org.cadenzaflow.bpm.engine.variable.value.ShortValue;
import org.cadenzaflow.bpm.engine.variable.value.StringValue;
import org.cadenzaflow.bpm.engine.variable.value.TypedValue;
import org.cadenzaflow.bpm.engine.variable.value.builder.FileValueBuilder;
import org.cadenzaflow.bpm.engine.variable.value.builder.ObjectValueBuilder;
import org.cadenzaflow.bpm.engine.variable.value.builder.SerializedObjectValueBuilder;
import org.cadenzaflow.bpm.engine.variable.value.builder.TypedValueBuilder;
