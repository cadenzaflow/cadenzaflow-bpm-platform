...
import org.cadenzaflow.bpm.identity.ldap.util.LdapTestEnvironment;
import org.cadenzaflow.bpm.identity.ldap.util.LdapTestEnvironmentRule;
...
public class LdapQueryToleranceTest {
  ...
  @Rule
  public ProcessEngineLoggingRule loggingRule = new ProcessEngineLoggingRule().level(Level.ERROR).watch("org.cadenzaflow.bpm.identity.impl.ldap");
