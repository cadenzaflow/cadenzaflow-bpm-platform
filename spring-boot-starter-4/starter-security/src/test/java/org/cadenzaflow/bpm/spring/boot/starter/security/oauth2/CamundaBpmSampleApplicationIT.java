 ...
 */
package org.cadenzaflow.bpm.spring.boot.starter.security.oauth2;
...
public class CamundaBpmSampleApplicationIT extends AbstractSpringSecurityIT {
  ...
  public void testWebappApiIsAvailableAndRequiresAuthorization() {
    ...
    ResponseEntity<String> entity = testRestTemplate.getForEntity(baseUrl + "/cadenzaflow/api/engine/engine/default/user", String.class);
