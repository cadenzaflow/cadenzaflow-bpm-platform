...
import org.cadenzaflow.bpm.spring.boot.starter.actuator.JobExecutorHealthIndicator;
import org.cadenzaflow.bpm.spring.boot.starter.actuator.ProcessEngineHealthIndicator;
...
@Configuration
@ConditionalOnProperty(prefix = "management.health.cadenzaflow", name = "enabled", matchIfMissing = true)
