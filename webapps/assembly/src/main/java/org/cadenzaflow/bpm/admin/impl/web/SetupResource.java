 ...
 */
package org.cadenzaflow.bpm.admin.impl.web;
...
import org.cadenzaflow.bpm.engine.rest.impl.UserRestServiceImpl;
...
import org.cadenzaflow.bpm.webapp.impl.WebappLogger;
...
public class SetupResource {
  ...
  protected void ensureCamundaAdminGroupExists(ProcessEngine processEngine) {
    ...
    if(identityService.createGroupQuery().groupId(Groups.CAMUNDA_ADMIN).count() == 0) {
      ...
      camundaAdminGroup.setName("cadenzaflow BPM Administrators");
