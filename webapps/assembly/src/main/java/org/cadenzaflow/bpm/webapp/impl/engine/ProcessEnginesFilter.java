 ...
 */
package org.cadenzaflow.bpm.webapp.impl.engine;
...
import org.cadenzaflow.bpm.admin.Admin;
import org.cadenzaflow.bpm.admin.AdminRuntimeDelegate;
import org.cadenzaflow.bpm.cockpit.Cockpit;
import org.cadenzaflow.bpm.cockpit.CockpitRuntimeDelegate;
import org.cadenzaflow.bpm.engine.ProcessEngine;
import org.cadenzaflow.bpm.engine.authorization.Groups;
import org.cadenzaflow.bpm.engine.rest.util.WebApplicationUtil;
import org.cadenzaflow.bpm.tasklist.Tasklist;
import org.cadenzaflow.bpm.tasklist.TasklistRuntimeDelegate;
import org.cadenzaflow.bpm.webapp.impl.security.filter.headersec.provider.impl.ContentSecurityPolicyProvider;
import org.cadenzaflow.bpm.webapp.impl.util.ServletContextUtil;
import org.cadenzaflow.bpm.webapp.impl.IllegalWebAppConfigurationException;
import org.cadenzaflow.bpm.webapp.impl.filter.AbstractTemplateFilter;
import org.cadenzaflow.bpm.webapp.impl.security.SecurityActions;
import org.cadenzaflow.bpm.webapp.impl.security.SecurityActions.SecurityAction;
import org.cadenzaflow.bpm.webapp.plugin.spi.AppPlugin;
import org.cadenzaflow.bpm.welcome.Welcome;
import org.cadenzaflow.bpm.welcome.WelcomeRuntimeDelegate;
...
public class ProcessEnginesFilter extends AbstractTemplateFilter {
  ...
  protected String getDefaultEngineName() {
    ...
    if(processEngineNames.isEmpty()) {
      throw new IllegalWebAppConfigurationException("No process engine found. cadenzaflow Webapp cannot work without a process engine. ");
